...
#define LCD_YRESOLUTION 320
#define LCD_SIF_TIMINGS (LCDIF_WR_2ND(2) | LCDIF_WR_1ST(2) | LCDIF_RD_2ND(2) |\
                         LCDIF_RD_1ST(2) | LCDIF_CSH(2) | LCDIF_CSS(2))
...
#define LCD_SIF_WROI    (LCDIF_F_RGB | LCDIF_F_PADDLSB | LCDIF_F_RGB565 | LCDIF_F_ITF_8B)           // LCD module data format (RGB565)
